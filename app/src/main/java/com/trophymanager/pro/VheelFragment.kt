...
import com.trophymanager.pro.databinding.FragmentVheelBinding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import kotlin.random.Random


class VheelFragment : Fragment() {
    ...
    private var _binding: FragmentVheelBinding? = null
    private val binding get() = _binding ?: throw RuntimeException("FragmentVheelBinding = null")
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVheelBinding.inflate(inflater, container, false)
        return binding.root
    }
